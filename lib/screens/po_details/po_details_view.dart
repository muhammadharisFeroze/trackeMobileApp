...
class PoDetailsView extends GetView<PoDetailsController> {
  const PoDetailsView({super.key});
            ...
            CustomScrollView(
                ...
                slivers: [
                  AppbarWidget(
                    ...
                    appBarTitle: 'Purchase Order Details', //'PO Details',
                    isMoreCustom: true,
                    name:
                        controller.homeController.selectedItem.value.custName ??
                            "",
                    message: controller
                            .homeController.selectedItem.value.poNoBuyer ??
                        "",
                    inquiryDetail:
                  ...
                  SliverPadding(
                      ...
                      sliver: SliverList(
                            ...
                            child: Column(
                              ...
                              children: [
                                ExpnadedRowWidget(
                                    ...
                                    descLeft: controller.homeController
                                            .selectedItem.value.oColorCode ??
                                        "",
                                ...
                                ExpnadedRowWidget(
                                    ...
                                    descLeft: controller.homeController
                                            .selectedItem.value.packageCode ??
                                        "",
                                ...
                                TitelDescWidget(
                                    title: "Quality Codes",
                                    desc: "${controller.searchList.length}"),
                                SizedBox(
                        ...
                        SearchTextScanButtonWidget(
                            textEditController: controller.searchTextController,
                            ...
                            onPressed: () {
                              controller.homeController.isScanSearch.value =
                                  true;
                              controller.homeController.selectedScanType.value =
                        ...
                        Padding(
                          padding: UIhelper.paddingHelper(context, bottom: 150),
                          child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  padding: EdgeInsets.all(getSize(context, 7)),
                                  decoration:
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          flex: 1,
                          child: DefaultButtonWidget(
                              enable: (controller.homeController.selectedItem
                                          .value.shipments ??
                                      0) >
                                  0,
                              buttonText:
                              ...
                              onPressed: () {
                                controller.homeController.selectedScanType
                                    .value = ScanType.purchaseOrder.index;
